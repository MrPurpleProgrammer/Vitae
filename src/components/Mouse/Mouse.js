...
function Mouse(props) {
    ...
    return(
        ...
        <circle class="cursor-circle" cx="70" cy="70" r="20" style={{fill: "rgb(30 85 180)", stroke: "rgb(30 85 180)"}}></circle>
        <circle class="cursor-circle" cx="74" cy="68" r="20" style={{fill: "#be7dff", stroke: "#be7dff"}}></circle>
      </svg>
    )
}
